          ...
          <div className="ml-9 flex-grow-1  w-full lg:w-10/10 xl:w-2/4">
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              <div className="mb-4">
                ...
                <input
                  className="shadow appearance-one border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="name"
                  type="text"
                />
              </div>
              <div className="mb-4">
                ...
                <div className="relative">
                  <select
                    className="block appearance-none w-full border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded leading-tight focus:outline-none focus:border-gray-500"
                    id="department"
                  >
                    <option></option>
